"""Router principal do módulo Facebook Ads."""

from fastapi import APIRouter

from projects.facebook_ads.api import (
    health,
    oauth,
    config_endpoints,
    sync,
...
authenticated_router.include_router(config_endpoints.router, prefix="/config", tags=["Facebook Ads - Config"])
