...
from shared.core.tracing.events import log_subagents_selected
...
def plan_execution(state: OrchestratorState) -> dict:
    ...
    logger.info("Criando plano de execucao para intencao: {intent}")
    ...
    logger.debug("Agentes selecionados: {plan['agents']}")
