"""
Endpoints de classificação de campanhas.
"""
...
class ClassificationResponse(BaseModel):
    """Resposta de classificação de campanha."""
    id: int
    config_id: int
    campaign_id: str
...
class ClassifyRequest(BaseModel):
    """Request para classificar campanhas."""
...
async def classify_campaigns(
    ...
    Executa o classificador ML nas campanhas especificadas
    ou em todas as campanhas ativas da configuração.
    """
    logger.info(
        "Solicitação de classificação de campanhas",
