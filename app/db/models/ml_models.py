...
class MLCampaignClassification(Base):
    """
    Classificação de campanhas por tier de performance.
    Mantém histórico de mudanças de tier.
    """
...
class MLFeature(Base):
    """
    Features extraidas de campanhas para uso em modelos ML.
    Armazena features calculadas por campanha e janela de tempo.
    """
